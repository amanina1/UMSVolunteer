                ...
                <div class="card-body">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $i; ?></td>
                        <th scope="row"><a href="editcert.php?eventid3=<?php echo $data['eventid'];?>" class="text-primary"><?php echo $data['eventname'];?></a></th>
                        <td><?php echo $data['startdate'];?></td>
                        <td><?php echo $data['enddate'];?></td>
                        
                      <td>
                        <center><div class="btn btn-dark btn-sm"><a href="editcert.php?eventid3=<?php echo $data['eventid'];?>"><i class="bx bxs-pencil"></i></div></center>
                      </td>
                      </tr>
                      <?php
                      $i++;
