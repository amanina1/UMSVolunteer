...
<div class="row">
        <div class="col-lg-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Recent Task </h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
					              <td><?php echo $i; ?></td>
                        <th scope="row"><a href="viewtask.php?id=<?php echo $data['eventid'];?>" class="text-primary"><?php echo $data['eventname'];?></a></th>
                        <td><?php echo $data['startdate'];?></td>
                        <td><?php echo $data['enddate'];?></td>
						            
						          <td>
                        <center><div class="btn btn-dark btn-sm"><a href="viewtask.php?id=<?php echo $data['eventid'];?>"><i class="bx bxs-pencil"></i></div></center>
						          </td>
                      </tr>
                      <?php
                      $i++;
