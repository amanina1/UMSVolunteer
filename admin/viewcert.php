...
$query23 = "SELECT * FROM user WHERE role='2'";
        ...
        <div class="col-lg-8">
						<div class="faq faq-style3">
							...
							<div class="panel-group" id="accordion3" role="tablist" aria-multiselectable="true">
								...
								?>
								<input class="btn btn-primary " name="submit" type="submit" value="Generate Certificate">
								<br></br>
			            ...
			            <div class="person">
			                <?php echo $exec_set12['fullname'];?>
			            </div>

			            <div class="reason">
			                <?php echo $exec_set1['eventdesc'];?>
			            </div>
			        </div>
