...
if(isset($_POST['submit'])){
    ...
    //update to table user
      ...
      if($data){
        ...
        echo "<script>alert('Successfully update an Club!');window.location.href='club.php';</script>";
      }else{

        echo "<script>alert('Not Successfully update an Club!');window.location.href='club.php';</script>";
      }
...
<div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-body">
              ...
              <!-- Vertical Form -->
              <form class="row g-3" action="editclub.php" method="POST">
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Club Name</label>
                  <input type="text" class="form-control" id="inputNanme4" name="clubname" value="<?php echo $query_exec['clubname'];?>">
                </div>
                
				<div class="col-12">
                  <label for="inputAddress" class="form-label">Full Name</label>
                  <input type="text" class="form-control" id="inputAddress" name="fullname" value="<?php echo $query_exec['fullname'];?>">
                </div>
				<div class="col-12">
                ...
                <div class="text-center">
                  <input class="btn btn-primary" type="submit" name="submit" value="Update Club">
