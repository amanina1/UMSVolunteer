...
if(isset($_POST['submit'])){
    ...
    if($password==$confirm_password){
      ...
      $query = "INSERT INTO user(username,password,confirm_password,fullname,clubname,email,role,image) VALUES('$username','$password','$confirm_password','$fullname','$clubname','$email','$role','$image')";
      $data = mysqli_query($con,$query);

      if($data){

        echo "<script>alert('Successfully Register Club!');window.location.href='index.php';</script>";
      }else{

        echo "<script>alert('Not Successfully Register');window.location.href='registerclub.php';</script>";
      }

    }else{

      echo "<script>alert('Password Not Match! Please Try Again Thanks!');window.location.href='registerclub.php';</script>";
    }
            ...
            <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Create an Club Account</h5>
                    <p class="text-center small">Enter your club details to create account</p>
                  </div>

                  <form action="registerclub.php" method="POST" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="clubname" class="form-control" id="yourName" required>
                      <div class="invalid-feedback">Please, enter your club name!</div>
                    </div>
                    <div class="col-12">
                      <label for="yourName" class="form-label">Club Image</label>
              ...
              <div class="credits">
                ...
                UMSVolunteer Copyright &copy; Universiti Malaysia Sabah.
              </div>
