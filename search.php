...
$query23 = "SELECT * FROM event WHERE eventstatus!='3' and isdelete!='1' and eventname LIKE '%$search%'";
...
<body style="background-color:#264653;">
	<div class="box-layout">
							...
							<div class="main-menu">
								...
								<div class="menu-right">
									<ul>
										...
										<br>
										<li><a href="index.php" class="menu-button">Log In</a></li>
									</ul>
								</div>
							</div>
						</div>
		...
		<section class="home-blog home-blog-uhv home-blog-six">
			<div class="overlay padding-120" style="background-color:#264653;">
			
				<div class="container">
					<div class="section-header text-center">
						<h3>List Events</h3>
						<p><em>Be a Part of Something Bigger than Yourself.</em></p>
					</div>
					<div class="row">
						<?php
