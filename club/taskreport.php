...
$query23 = "SELECT * FROM event WHERE userid='$userid' and eventstatus='3'";
										...
										<tbody>
											...
											<tr>
												...
												<td class="session" style="color:white"><span><i class="fa fa-user"
															aria-hidden="true"></i></span><?php echo $data['eventname'];?></td>
												<td style="color:white"><?php echo $data['startdate'];?></td>
												<td style="color:white"><?php echo $data['enddate'];?></td>
												<td style="color:white"><a href="viewtaskreport.php?eventid3=<?php echo $data['eventid']?>" class="default-button">View Report</a></td>
