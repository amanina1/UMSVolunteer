			...
			<div style="background-color:#264653;">
				<div class="container">
					...
					<br>
						...
						<h3><?php echo $exec_set17['eventname'];?></h3>
					</div>
									...
									<table>
										<thead>
											<tr>
												...
												<th class="session" style="background-color:#2a9d8f">User Name</th>
												<th class="spekers" style="background-color:#2a9d8f">Event Status</th>
										...
										<tbody>
											...
											<tr>
												...
												<td style="color:white"><?php if($data['statusevent']=='3'){?>Completed<?php }?></td>
												<td style="color:white"><?php if($data['verified']=='1'){?>Approved<?php }else if($data['verified']=='2'){?>Rejected<?php }?></td>
												<td style="color:white"><?php if($data['verified']=='1'){?><a href="certificateclub3.php?eventid4=<?php echo $data['eventid']?>&userid=<?php echo $data['userid']?>" class="default-button">View Certificate</a><?php }else if($data['verified']=='2'){?><a ><?php echo $data['reason'];}?></a></td>
