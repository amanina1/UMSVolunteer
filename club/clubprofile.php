...
if(isset($_POST['submit'])){
    ...
    if($extension==null){
     ...
     if($data){
        ...
        echo "<script>alert('Successfully Update an profile!');window.location.href='clubprofile.php';</script>";
      }else{

        echo "<script>alert('Not Successfully Update an profile!');window.location.href='clubprofile.php';</script>";
      }
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h2><?php echo $exec_set['clubname'];?></h2>
        ...
        <div class="col-xl-8">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $exec_set['clubname'];?></div>
                  </div>
          ...
          <div class="row">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="clubprofile.php" method="POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Club Name</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="clubname" type="text" class="form-control" id="fullName" value="<?php echo $exec_set['clubname'];?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="username" type="text" class="form-control" id="fullName" value="<?php echo $exec_set['username'];?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="password" type="password" class="form-control" id="fullName" value="<?php echo $exec_set['password'];?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="text" class="form-control" id="fullName" value="<?php echo $exec_set['email'];?>">
                      </div>
                    </div>
                    ...
                    <div class="text-center">
                      <input type="submit" style="background-color:#2a9d8f;" class="btn btn-primary" name="submit" value="Save Changes">
                    </div>
