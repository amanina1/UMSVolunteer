...
$query23 = "SELECT * FROM event WHERE userid='$userid' and isdelete!='1' and eventstatus!='3' ORDER BY eventid DESC ";
									...
									<table>
										...
										<tbody>
											...
											<tr>
												...
												<td style="color:white"><a href="forumclub2.php?eventid3=<?php echo $data['eventid']?>" class="default-button">View Forum</a></td>
