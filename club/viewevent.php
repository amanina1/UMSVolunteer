                            ...
                            <div class="blog-content">
                                <div>
                                    <ul class="post-meta">
                                        ...
                                        <?php
										$eventid_temp=$id;
										$result3 = "SELECT sum(taskuser)as count FROM `task` WHERE eventid='$eventid_temp'";
                                    ...
                                    <div class="content">
                                        ...
                                        <?php
										if(($exec_set['eventstatus']=='1') && ($valid_role=='3')){
										?>
                                        	<a href="joinevent.php" class="default-button">Join</a>
                                        <?php
