...
$query23 = "SELECT * FROM event WHERE userid='$userid' and eventstatus='2' ORDER BY eventid DESC";
...
<body style="background-color:#264653;">
	<div class="box-layout">
		...
		<section class="blog-page padding-120 home-blog-uhv ">
            <div class="container">
			<br>
			<a href="createevent.php" class="btn btn-primary">Create An Event </a> <br><br><br>

			<a href="myevent.php" class="btn btn-danger" style="background-color:#e76f51;">My New Event </a>
			...
			<br>
				<h3 style="color:white">List On Going Events</h3>
<br>				
			</div>
                <div class="row">
                            ...
                            <div class="blog-content">
                                <div>
                                    <ul class="post-meta">
                                        ...
                                        <li><span class="icon flaticon-like"></span><a href="#" style="background-color:#e63946; color:black;">OnGoing</a></li>
                                    </ul>
                                    <!-- post-meta -->
                                    <div class="content">
                                        ...
                                        <a href="viewtask.php?id=<?php echo $data['eventid'];?>" class="default-button" style="background-color:#2a9d8f;">View Task</a>&nbsp&nbsp&nbsp&nbsp
										 <a href="completedeventaction.php?id=<?php echo $data['eventid'];?>" class="default-button" style="background-color:#2a9d8f;">Event Completed</a>
                                    </div>
                                    <!-- content -->
                                </div>
                            </div>
