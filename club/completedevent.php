...
$query23 = "SELECT * FROM event WHERE userid='$userid' and eventstatus='3' ORDER BY eventid DESC";
...
<body style="background-color:#264653;">
	<div class="box-layout">
		...
		<section class="blog-page padding-120 home-blog-uhv ">
			...
			<a href="completedevent.php" class="btn btn-danger" style="background-color:#fca311;">Completed Event </a>
			<div class="section-header text-center">
			<br>
				<h3 style="color:white">List Completed Events</h3>
<br>				
			</div>
                <div class="row">
                            ...
                            <div class="blog-content">
                                <div>
                                    <ul class="post-meta">
                                        ...
                                        <li><span class="icon flaticon-like"></span><a href="#" style="background-color:#06d6a0; color:black;">Completed</a></li>
                                    </ul>
                                    <!-- post-meta -->
                                    <div class="content">
