  									...
  									<table border = "1">
										<thead>
											<tr>
												...
												<th class="session" style="background-color:#2a9d8f">Task Name<?php echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";?></th>
												<th class="spekers" style="background-color:#2a9d8f">Date<?php echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";?></th>
												<th class="spekers" style="background-color:#2a9d8f">Time<?php echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";?></th>
												<th class="spekers" style="background-color:#2a9d8f">Join<?php echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";?></th>
												<th class="spekers" style="background-color:#2a9d8f">Required<?php echo "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp";?></th>
											</tr>
										</thead>
										<tbody>
											<?php
											...
											<tr>
												...
												<td style="color:white"><?php echo $data['datetask'];?></td>
												<td style="color:white"><?php echo $data['starttimetask'];?></td>
												<td style="color:white"><?php echo $test_result_count1;?></td>
												<td style="color:white"><?php echo $data['taskuser'];?></td>
											</tr>
											<?php
											}
											?>
