...
$query231 = "SELECT * FROM joinevent WHERE userid='$userid' and eventstatus='3' and iscancel!='1' ORDER BY id DESC";
	...
	<div class="box-layout">
		...
		<section class="blog-page padding-120 home-blog-uhv ">
			...
			<div class="section-header text-center">
				<br><br>
				<h3 style="color:white">List Completed Events</h3> <br>
			</div>
                <div class="row">
                    	...
                    	<?php
                             while($data=mysqli_fetch_array($exec231)){
								...
								$query23 = "SELECT * FROM event WHERE eventid='$eventidjoin' and eventstatus='3' and isdelete!='1'";
