...
$query231 = "SELECT * FROM joinevent WHERE userid='$userid' and eventstatus='1' and iscancel!='1' ORDER BY id DESC";
...
<body style="background-color:#264653;">
	<div class="box-layout">
		...
		<section class="blog-page padding-120 home-blog-uhv ">
			...
			<a href="listeventjoined.php" class="btn btn-danger" style="background-color:#fca311;">Up Coming Event </a>
			...
			<div class="section-header text-center">
				<br><br>
				<h3 style="color:white">List New Events</h3> <br>
			</div>
                <div class="row">
                    	...
                    	<?php
                             while($data=mysqli_fetch_array($exec231)){
								...
								$query23 = "SELECT * FROM event WHERE eventid='$eventidjoin' and eventstatus='1' and isdelete!='1'";
