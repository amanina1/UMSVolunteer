...
$query23 = "SELECT * FROM volunteertask WHERE userid='$userid' and statusevent='3' and verified='1'";
									...
									<table>
										...
										<tbody>
											...
											<tr>
												...
												<td style="color:white;"><a href="certificate2.php?eventid3=<?php echo $data['eventid']?>" class="default-button">View Certificate</a></td>
