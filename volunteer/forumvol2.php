...
if(isset($_POST['submit'])){
	...
	$time=date('H:i:a');
      ...
      if($data){
        ...
        echo "<script>alert('Successfully add an comment!');window.location.href='forumvol2.php?eventid3=$event_id2';</script>";
      }else{

        echo "<script>alert('Not Successfully add an comment!');window.location.href='forumvol2.php?eventid3=$event_id2';</script>";
      }
			...
			<div class="container">
				<div class="section-wrapper row">
					...
					<div class="col-lg-12">
						...
						<br>
							<h4 class="title" style="color:white">Forum</h4> <br>
							<div class="panel-group" id="accordion3" role="tablist" aria-multiselectable="true">
								...
								<div class="panel">
									...
									<div id="collapse1-1" class="faq-collapse collapse show" role="tabpanel"
										...
										?>
										<form action="forumvol2.php" method="POST">
										<div class="row mb-3">
										...
										<div class="col-12">
				                      		<input class="btn btn-primary " name="submit" type="submit" style="background-color:#2a9d8f" value="Add Comment">
				                    	</div>
				                    	</form>
									</div>
